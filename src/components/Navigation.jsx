                    ...
                    <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white focus:outline-none min-[1000px]:max-w-lg">
                      ...
                      >
                        <div className="absolute top-0 right-0">
                          <button
                            type="button"
                            className="z-50 flex hidden h-10 w-10 items-center justify-center rounded-full bg-teal-400  shadow-md focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500  "
                            onClick={() => setSidebarOpen(false)}
                          >
                            <span className="sr-only">Close sidebar</span>
                            <XMarkIcon
                      ...
                      <div className="light-green h-0 flex-1 overflow-y-auto pt-0 pb-4">
                        ...
                        <nav aria-label="Sidebar" className="mt-2">
                              ...
                              <Link
                                ...
                                className={classNames(
                                  item.current
                                    ...
                                    : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900',
                                  'fot-bold group flex items-center rounded-md px-2 py-1.5 text-base text-lg sm:py-4  sm:text-xl md:py-2'
                                )}
                                aria-current={item.current ? 'page' : undefined}
                              >
                                <item.icon
                          ...
                          <hr
                            ...
                            aria-hidden="true"
                          />
                          <div className="light-green -mt-4 space-y-1 bg-gray-50 px-2">
                            {secondaryNavigation.map((item) => (
                              <a
                                key={item.name}
                                href={item.href}
                                className="group flex items-center rounded-md px-2 py-2 text-lg text-base font-semibold font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 sm:text-xl"
                              >
                                <item.icon
                                  className="mr-4 h-6 w-6 flex-shrink-0 font-bold text-gray-400 group-hover:text-gray-500 sm:text-xl"
                                  aria-hidden="true"
                                />
                                {item.name}
                              </a>
